...
DOCKER_IMAGE_URI='mikomel/demo-pytorch:latest'
OUTPUT_DIR_HOST='/raid/shared/mmalkinski'
OUTPUT_DIR_GUEST='/output'
OUTPUT_FILENAME="mikomel-demo-pytorch-latest_${timestamp}.tar"
SINGULARITY_CONTAINER_PATH="/home2/faculty/mmalkinski/singularity/mikomel-demo-pytorch_${timestamp}.sif"
